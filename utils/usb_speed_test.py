...
# Install dependency:  sudo pip3 install pyusb
...
if dev is None:
    raise ValueError('Device not found. Make sure the Pico is connected and the firmware is running.')

# Detach kernel driver if active (needed on Linux)
...
repeat = 3  # Average over multiple runs for more stable results
